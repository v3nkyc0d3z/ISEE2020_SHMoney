    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (type.equals("Income")) {
            ...
            catBtn.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    AlertDialog.Builder mBuilder = new AlertDialog.Builder(EditTransaction.this);
                    mBuilder.setTitle("Please pick a category");
                    mAdapter = new CategoryAdapter(EditTransaction.this, mIncomeCategoryList);
            ...
            save.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(amount.length() == 0){
                        ...
                        updateData(id,date,amt,"NA",category,editcomment,"Income","EUR",false,"Default");
                        TransactionList updatedTransaction = new TransactionList(id,date,amount,"NA",category,editcomment,"Income","you got");
...
//==================================================================================================================================
            ...
            catBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    AlertDialog.Builder mBuilder = new AlertDialog.Builder(EditTransaction.this);
                    mBuilder.setTitle("Please pick a category");
                    mAdapter = new CategoryAdapter(EditTransaction.this, mExpenseCategoryList);
            ...
            modeMenu.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    AlertDialog.Builder nBuilder = new AlertDialog.Builder(EditTransaction.this);
                    nBuilder.setTitle("Please pick a payment mode");
                    nAdapter = new ModeAdapter(EditTransaction.this, mModeList);
            ...
            save.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(amount.length() == 0){
                        ...
                        String editcomment = HandleNewLine(comment);
                        int id = transaction.getId();
                        updateData(id,date,amt,ModePicked,category,editcomment,"Expense","EUR",false,"Default");
